...
tar cjvf rapidxml_1.13.orig.tar.bz2 rapidxml-1.13
cd rapidxml-1.13
rm -rf debian
mkdir -p debian
#Use the LICENSE file from nodejs as copying file
cp license.txt debian/copying
...
echo "Description: RapidXML fast XML parser (header-only library)" >> debian/control
#Create rules file
