...
echo "ln -sf /usr/lib/libleveldb.so.1.14 /usr/lib/libleveldb.so.1" > debian/libleveldb.postinst
...
echo -e '\tcp libleveldb.so.1.14 libleveldb.a debian/libleveldb/usr/lib' >> debian/rules
